...
#define DSP_SINGLE_ALL_MAX       7470///-5.3db 
#define DSP_SINGLE_ALL_DEFAULT   7470///-5.3db - 20180927
...
extern void Dsp_Single_Mute_Init(void);
...
extern void Dsp_SlowCloseSingle(void);
