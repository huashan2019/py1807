...
SCH_BOOL Dsp_USB_Pro(SCH_U8 data)
{
	...
	SIGMASTUDIOTYPE(pow(10,Data/20),buff);
	SIGMA_SAFELOAD_WRITE_REGISTER(DEVICE_ADDR_IC_1, MOD_ROUTER1_ALG0_AUDIOSIGNALROUTER32S300ALG1INPUTGAIN4_ADDR, 1, buff);
	SIGMA_SAFELOAD_WRITE_REGISTER(DEVICE_ADDR_IC_1, MOD_ROUTER1_ALG0_AUDIOSIGNALROUTER32S300ALG1INPUTGAIN5_ADDR, 1, buff);
